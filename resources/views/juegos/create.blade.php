...
<div class="container">
    ...
    <form action="{{ route('juegos.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="edicion" class="form-control @error('edicion') is-invalid @else is-valid @enderror" id="edicion" value="{{ old('edicion') }}">
            @error('edicion')
                <div class="invalid-feeback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="num_jugadores_min" class="form-control @error('num_jugadores_min') is-invalid @else is-valid @enderror" id="num_jugadores_min" value="{{ old('num_jugadores_min') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="num_jugadores_max" class="form-control @error('num_jugadores_max') is-invalid @else is-valid @enderror" id="num_jugadores_max" value="{{ old('num_jugadores_max') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="edad_recomendada" class="form-control @error('edad_recomendada') is-invalid @else is-valid @enderror" id="edad_recomendada" value="{{ old('edad_recomendada') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="duracion_aprox" class="form-control @error('duracion_aprox') is-invalid @else is-valid @enderror" id="duracion_aprox" value="{{ old('duracion_aprox') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="editor" class="form-control @error('editor') is-invalid @else is-valid @enderror" id="editor" value="{{ old('editor') }}">
            @error('editor')
                <div class="invalid-feeback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="disenador" class="form-control @error('disenador') is-invalid @else is-valid @enderror" id="disenador" value="{{ old('disenador') }}">
            @error('disenador')
                <div class="invalid-feeback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="ano_publicacion" class="form-control @error('ano_publicacion') is-invalid @else is-valid @enderror" id="ano_publicacion" value="{{ old('ano_publicacion') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.1" name="dureza" class="form-control @error('dureza') is-invalid @else is-valid @enderror" id="dureza" value="{{ old('dureza') }}">
            @error('dureza')
                <div class="invalid-feeback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="rating" class="form-control @error('rating') is-invalid @else is-valid @enderror" id="rating" value="{{ old('rating') }}">
            @error('rating')
                <div class="invalid-feeback">{{ $message }}</div>
            @enderror
        </div>
